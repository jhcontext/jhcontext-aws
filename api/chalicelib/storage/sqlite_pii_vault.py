"""SQLite-backed PII vault for local development without AWS.

Vendored from jhcontext-sdk v0.3.2 (jhcontext/server/storage/pii_vault.py).
Implements the same PIIVault protocol as DynamoDBPIIVault.
